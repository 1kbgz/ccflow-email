...
lint-py:  ## lint python with ruff
	python -m ruff check ccflow_email
	python -m ruff format --check ccflow_email
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ccflow_email
	python -m ruff format ccflow_email
...
test:  ## run python tests
	python -m pytest -v ccflow_email/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ccflow_email/tests --cov=ccflow_email --cov-report term-missing --cov-report xml
